...
# negativo
Funcionalidade: Tentar realizar o acesso a plataforma utilizando uma senha números aleatórios

Cenário: Validar tratamento de erro - Senha com números aleatórios
Dado que eu acesso a aplicação
Quando eu preencher o usuário utilizando o RG '123.123.123.12'
E eu preencher a senha com números aleatórios
Então o usuário não poderá acessar a plataforma
E uma mensagem de erro senha inválida
...
Cenário: Validar quantidade permitida de caracteres no campo usuário
Dado que eu acesso a aplicação
Quando eu preencher o usuário utilizando um RG com mais de 8 dígitos
Então o campo de usuário deverá estar limitado a 8 caracteres
...
Quando eu executar a query utilizando o RG '123.123.123.12'
